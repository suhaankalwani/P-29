...
function setup() {
  ...
  block26 = new Block(730,150,30,40);
  block27 = new Block(760,150,30,40);
  block28 = new Block(790,150,30,40);
  //level three
  block29 = new Block(700,125,30,40);
  block30 = new Block(730,125,30,40);
  block31 = new Block(760,125,30,40);
  //top
  block32 = new Block(790,100,30,40);
